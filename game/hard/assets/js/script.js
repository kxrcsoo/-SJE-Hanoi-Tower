...
function registerGame() {
    ...
    pole = 1;
    polePosition = 7;
    disk7 = new Disk(7,x1,y1,x2,y2,pole,polePosition)
    ...
    pole = 1;
    polePosition = 8;
    disk8 = new Disk(8,x1,y1,x2,y2,pole,polePosition)

}

registerGame();

let firstpole = [disk1, disk2, disk3, disk4, disk5, disk6, disk7, disk8];
let secondpole = [];
let thirdpole = [];
